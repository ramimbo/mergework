        ...
        with session_scope(db_url) as session:
            ...
            if query_text is not None:
                ...
                if normalized_query:
                    ...
                    text_issue_number = issue_number_search_value(normalized_query)
                    text_filter = or_(
                    ...
                    if text_issue_number is not None:
                        text_filter = or_(text_filter, Bounty.issue_number == text_issue_number)
