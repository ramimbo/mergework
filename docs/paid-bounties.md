...
- [Accepted work activity](https://mrwk.ltclab.site/activity) for recent
  proof-backed bounty payments grouped by contributor.
- [Activity API](https://api.mrwk.ltclab.site/api/v1/activity) for
...
- [Ledger API](https://api.mrwk.ltclab.site/api/v1/ledger) and
  `GET /api/v1/proofs/{proof_hash}` for individual ledger entries and public
  proof payloads.

Historical host aliases may still appear in older comments and examples:

- [MergeWork alias](https://mrwk.online/activity)
- [Activity API alias](https://api.mrwk.online/api/v1/activity)
